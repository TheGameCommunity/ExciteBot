	...
	public String getAuditMessage(CommandContext context) {
		...
		if(context.isConsoleMessage()) {
			...
			if(message == null || message.isEmpty()) {
				return DiscordUser.toDetailedString(context.getDiscordAuthor()) + " refunded " + amount + " " + currency + " into the " + wallet + " wallet of " + user;
			}
			return DiscordUser.toDetailedString(context.getDiscordAuthor()) + " refunded " + amount + " " + currency + " into the " + wallet + " wallet of " + user + " due to " + message;
		}
	}
