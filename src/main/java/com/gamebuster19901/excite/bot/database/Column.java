...
public enum Column {
	...
	//AUDITS
	AUDIT_ID("auditID", AUDITS, AUDIT_BANS, AUDIT_BOT_MSG_DEL, AUDIT_COMMANDS, AUDIT_NAME_CHANGES, AUDIT_PARDONS, AUDIT_PROFILE_DISCOVERIES, AUDIT_RANK_CHANGES, AUDIT_PROFILE_LOGINS, AUDIT_PROFILE_LOGOUTS, MAIL),
	...
	//DISCORD_USER
	DISCORD_ID("discordID", ADMINS, AUDIT_BOT_MSG_DEL, DISCORD_USERS, OPERATORS, PLAYERS, WIIS),
