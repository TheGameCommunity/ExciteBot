...
public enum Column implements Function {
	...
	//AUDITS
	AUDIT_ID("auditID", AUDITS, AUDIT_BANS, AUDIT_BOT_MSG_DEL, AUDIT_COMMANDS, AUDIT_NAME_CHANGES, AUDIT_PARDONS, AUDIT_PROFILE_DISCOVERIES, AUDIT_RANK_CHANGES, AUDIT_PROFILE_LOGINS, AUDIT_PROFILE_LOGOUTS, AUDIT_WII_REGISTER, MAIL, AUDIT_TRANSACTIONS),
	...
	//DISCORD_USER
	DISCORD_ID("discordID", ADMINS, AUDIT_BOT_MSG_DEL, AUDIT_WII_REGISTER, BETA_TESTERS, DISCORD_USERS, OPERATORS, PLAYERS, WIIS),
	@Deprecated
	...
	MAIL_ID("mailID", MAIL),
	SENDER("sender", MAIL),
	RECIPIENT("recipient", MAIL, AUDIT_TRANSACTIONS),
	INCOMING("incoming", MAIL),
	MAIL_TYPE("mailType", MAIL),
	FILE("file", MAIL),
	
	//TRANSACTIONS
	TRANSACTION_TYPE("transactionType", AUDIT_TRANSACTIONS),
	//RECIPIENT (see MAIL)
	AMOUNT("amount", AUDIT_TRANSACTIONS),
	CURRENCY("currency", AUDIT_TRANSACTIONS),
	WALLET("wallet", AUDIT_TRANSACTIONS),
	...
	//WIIS
	WII_ID("wiiID", AUDIT_WII_REGISTER, WIIS),
	REGISTRATION_CODE("registrationCode", WIIS),
	UNREGISTER("unregister", AUDIT_WII_REGISTER)
