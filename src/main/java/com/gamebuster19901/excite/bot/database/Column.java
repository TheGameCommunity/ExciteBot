...
public enum Column {
	...
	//AUDITS
	AUDIT_ID("auditID", AUDITS, AUDIT_BANS, AUDIT_COMMANDS, AUDIT_NAME_CHANGES, AUDIT_PARDONS, AUDIT_DISCOVERIES, AUDIT_RANK_CHANGES),
	...
	//DISCOVERY
	DISCOVERED_ID("discoveredID", AUDIT_DISCOVERIES),
