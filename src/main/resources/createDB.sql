...
CREATE TABLE IF NOT EXISTS `audit_commands` (
  `auditID` bigint unsigned NOT NULL,
  `serverName` varchar(45) COLLATE utf8mb4_bin DEFAULT NULL,
  `serverID` bigint unsigned NOT NULL,
  `channelName` varchar(45) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `audit_name_changes` (
  `auditID` bigint unsigned NOT NULL,
  `oldName` varchar(8) COLLATE utf8mb4_bin NOT NULL,
  `newName` varchar(8) COLLATE utf8mb4_bin NOT NULL,
  `playerID` int NOT NULL,
  `friendCode` varchar(14) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`auditID`),
  UNIQUE KEY `auditID_UNIQUE` (`auditID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;


CREATE TABLE IF NOT EXISTS `audit_pardons` (
  `auditID` bigint unsigned NOT NULL,
...
CREATE TABLE IF NOT EXISTS `audit_profile_discoveries` (
  `auditID` bigint unsigned NOT NULL,
  PRIMARY KEY (`auditID`),
  UNIQUE KEY `auditID_UNIQUE` (`auditID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
...
CREATE TABLE IF NOT EXISTS `audit_rank_changes` (
  `auditID` bigint unsigned NOT NULL,
  `promotee` varchar(45) COLLATE utf8mb4_bin NOT NULL,
...
CREATE TABLE IF NOT EXISTS `audits` (
  ...
  `issuerName` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  `description` text COLLATE utf8mb4_bin,
  `issued` varchar(45) COLLATE utf8mb4_bin NOT NULL,
  PRIMARY KEY (`auditID`),
  UNIQUE KEY `auditID_UNIQUE` (`auditID`)
...
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_bans TO 'Operator';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_commands TO 'Operator';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_name_changes TO 'Operator';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_pardons TO 'OPERATOR';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_profile_discoveries TO 'Operator';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audit_rank_changes TO 'Operator';
GRANT CREATE, DELETE, INSERT, SELECT, UPDATE, SHOW VIEW ON excitebot.audits TO 'Operator';
